            ...
            <form action="{{route('store.subscriptionss')}}" method="POST">
                ...
                <div class="availcoach container">
                    <label class="cardavail">
                        <input type="radio" name="coachprefer" value="Jayden Salazarz">
                        <div class="card-content">
                            <img src="othercss/imagesss/coach/11.jpg" alt="">
                            <h3 class="namecoach">Jayden Salazar</h3>
                            <p class="titlez">Zumba Coach</p>
                            <div class="infoavail">
                                <div class="info-item">
                    ...
                    <label class="cardavail">
                        <input type="radio" name="coachprefer" value="Rhylee Cruz">
                        <div class="card-content">
                            <img src="othercss/imagesss/coach/12.jpg" alt="">
                            <h3 class="namecoach">Rhylee Cruz</h3>
                            <p class="titlez">Zumba Coach</p>
                            <div class="infoavail">
                                <div class="info-item">
                                    <i class="fa-solid fa-dumbbell"></i>
                    ...
                    <label class="cardavail">
                        <input type="radio" name="coachprefer" value="Vince Santos">
                        <div class="card-content">
                            <img src="othercss/imagesss/coach/13.jpg" alt="">
                            <h3 class="namecoach">Vince Santos</h3>
                            <p class="titlez">Zumba Coach</p>
                            <div class="infoavail">
                                <div class="info-item">
                                    <i class="fa-solid fa-dumbbell"></i>
