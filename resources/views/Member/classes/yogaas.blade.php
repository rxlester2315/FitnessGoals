    ...
    <body data-spy="scroll" data-target="#navbarNav" data-offset="50">
        ...
        <section class="main section" id="mains">
            ...
            <div class="yogacards-container">
                <div class="yogacards">
                    <img src="othercss/imagesss/yoga/hata.jpg" alt="">
                    <div class="infocard">
                        <h3>Hatha Yoga
                        </h3>

                        <p>Hatha yoga is a gentle introduction to the most basic yoga postures. It is often slower-paced
                            and focuses on breath control and alignment.</p>
                ...
                <div class="yogacards">
                    ...
                    <div class="infocard">
                        <h3>Vinyasa Yoga</h3>
                        <p>Vinyasa involves a dynamic flow of poses coordinated with the breath. This style often
                            includes creative transitions between poses and can be faster-paced</p>
                        <button class="btn btn-warning">View Details</button>
                    </div>
                </div>
                ...
                <div class="yogacards">
                    ...
                    <div class="infocard">
                        <h3>Ashtanga Yoga</h3>
                        <p>Ashtanga is a rigorous style involving a fixed sequence of poses performed in a specific
                            order. The practice is physically demanding and includes synchronization of breath and
                            movement.</p>
                ...
                <div class="yogacards">
                    ...
                    <div class="infocard">
                        <h3>Iyengar Yoga</h3>
                        <p>Focuses on precise alignment in each posture and uses props such as blocks, straps, and
                            cushions to aid alignment. It can be slower-paced and methodical.</p>
                        <button class="btn btn-warning">View Details</button>
                ...
                <div class="yogacards">
                    ...
                    <div class="infocard">
                        <h3>Bikram Yoga</h3>
                        <p>Involves a set series of 26 poses practiced in a heated room (around 105°F or 40°C) to induce
                            sweating and detoxification.</p>
                        <button class="btn btn-warning">View Details</button>
                ...
                <div class="yogacards">
                    ...
                    <div class="infocard">
                        ...
                        <p>A spiritual style that focuses on awakening the dormant energy (kundalini) at the base of the
                            spine through repetitive movements, breathing techniques, chanting, and meditation.</p>
                        <button class="btn btn-warning">View Details</button>
