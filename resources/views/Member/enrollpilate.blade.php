            ...
            <form action="{{route('store.subscriptionss')}}" method="POST">
                ...
                <div class="availcoach container">
                    <label class="cardavail">
                        <input type="radio" name="coachprefer" value="Sheena Cruz">
                        <div class="card-content">
                            <img src="othercss/imagesss/coach/8.jpg" alt="">
                            <h3 class="namecoach">Sheena Cruz</h3>
                            <p class="titlez">Pilates Coach</p>
                            <div class="infoavail">
                                <div class="info-item">
                    ...
                    <label class="cardavail">
                        <input type="radio" name="coachprefer" value="Caroline Guiteriez">
                        <div class="card-content">
                            <img src="othercss/imagesss/coach/9.jpg" alt="">
                            <h3 class="namecoach">Caroline Guiteriez</h3>
                            <p class="titlez">Pilates Coach</p>
                            <div class="infoavail">
                                <div class="info-item">
                                    <i class="fa-solid fa-dumbbell"></i>
                    ...
                    <label class="cardavail">
                        <input type="radio" name="coachprefer" value="Anne Krist Santos">
                        <div class="card-content">
                            <img src="othercss/imagesss/coach/10.jpg" alt="">
                            <h3 class="namecoach">Anne Krist Santos</h3>
                            <p class="titlez">Pilates Coach</p>
                            <div class="infoavail">
                                <div class="info-item">
                                    <i class="fa-solid fa-dumbbell"></i>
