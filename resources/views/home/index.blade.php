            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{url('login')}}" class="nav-link smoothScroll">Login</a>
                        </li>
                    </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-10 mx-auto col-12">
                        <div class="hero-text mt-5 text-center">
                            ...
                            <h1 class="text-white" data-aos="fade-up" data-aos-delay="500">Upgrade your body at Gymso
                                Fitness</h1>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="d-flex flex-column justify-content-center ml-lg-auto mr-lg-5 col-lg-5 col-md-6 col-12">
                        ...
                        <h6 class="mb-4 text-white" data-aos="fade-up">Your membership is up to 2 months FREE ($62.50
                            per month)</h6>

                        <p data-aos="fade-up" data-aos-delay="200">Gymso is free HTML template by <a rel="nofollow"
                                href="https://www.tooplate.com" target="_parent">Tooplate</a> for your commercial
                            website. Bootstrap v4.2.1 Layout. Feel free to use it.</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="mt-lg-5 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                        ...
                        <p data-aos="fade-up" data-aos-delay="400">You are NOT allowed to redistribute this HTML
                            template downloadable ZIP file on any template collection site. You are allowed to use this
                            template for your personal or business websites.</p>

                        <p data-aos="fade-up" data-aos-delay="500">If you have any question regarding <a rel="nofollow"
                                href="https://www.tooplate.com/view/2119-gymso-fitness" target="_parent">Gymso Fitness
                                HTML template</a>, you can <a rel="nofollow" href="https://www.tooplate.com/contact"
                                target="_parent">contact Tooplate</a> immediately. Thank you.</p>
                    ...
                    <div class="mr-lg-auto mt-5 mt-lg-0 mt-md-0 col-lg-3 col-md-6 col-12" data-aos="fade-up"
                        data-aos-delay="800">
                        <div class="team-thumb">
                            <img src="landing/images/team/team-image01.jpg" class="img-fluid" alt="Trainer">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                        <div class="class-thumb">
                            <img src="landing/images/class/yoga-class.jpg" class="img-fluid" alt="Class">
                    ...
                    <div class="mt-5 mt-lg-0 mt-md-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="500">
                        <div class="class-thumb">
                            <img src="landing/images/class/crossfit-class.jpg" class="img-fluid" alt="Class">
                    ...
                    <div class="mt-5 mt-lg-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                        <div class="class-thumb">
                            <img src="landing/images/class/cardio-class.jpg" class="img-fluid" alt="Class">
